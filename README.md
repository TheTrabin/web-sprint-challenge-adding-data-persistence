...
A relational Database means everything is structured.

2. Why do tables need a `primary key`?

A Primary Key is a sort of method of identification for each row vs column. The Row is the entry, and the Primary key is sort of the identifier while the rest of it is more or less additive definition.

Primary key = This is the entity.
Other columns = This is the descriptions.
...
A Bridge betwixt the two to bind the entities together.
...
- [ ] Build an API with endpoints for:
  ...
  - [x] adding projects.
  - [x] retrieving a list of projects. -Includes individual
  - [x] adding tasks.
